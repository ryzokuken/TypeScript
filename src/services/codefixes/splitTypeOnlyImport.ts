...
function splitTypeOnlyImport(changes: textChanges.ChangeTracker, importDeclaration: ImportDeclaration | undefined, context: CodeFixContextBase) {
    ...
    changes.replaceNode(
        ...
        factory.updateImportDeclaration(
            ...
            factory.updateImportClause(importClause, importClause.isTypeOnly, importClause.name, /*namedBindings*/ undefined, undefined),
    ...
    changes.insertNodeAfter(
        ...
        factory.createImportDeclaration(
            /*modifiers*/ undefined,
            factory.updateImportClause(importClause, importClause.isTypeOnly, /*name*/ undefined, importClause.namedBindings, undefined),
            importDeclaration.moduleSpecifier,
            importDeclaration.attributes,
        ),
    );
